...
const CITIES: CityData[] = [
  {
    ...
    venues: [
      ...
      // ── PARIS PLAYGROUNDS ────────────────────────────────────────────────
      { name: 'Jardin du Luxembourg — Playground', lat: 48.8462, lon: 2.3372, category: 'playground', award: '⭐ Market combo: Rue Mouffetard market 10 min away', tagline: "Paris's best playground in its most beautiful garden. Don't miss Rue Mouffetard.", desc: "The Luxembourg playground is the finest in Paris — a sprawling fantasy of slides, wooden towers, swings, trampolines, and a miniature carousel. Admission ~€3/child. The stunning formal garden surrounds it. Combo: walk 10 minutes to Rue Mouffetard, one of Paris's oldest market streets — incredible cheese, charcuterie, boulangeries — pick up a picnic feast and bring it back to the garden. 🗺️ https://maps.google.com/?q=Jardin+du+Luxembourg+Playground+Paris+75006", kidFriendly: true },
      { name: 'Jardin des Tuileries — Playground', lat: 48.8638, lon: 2.3275, category: 'playground', award: '⭐ Market combo: Rue de Rivoli patisseries and Stohrer on Montorgueil nearby', tagline: "Massive playground inside the Tuileries. Between the Louvre and Place de la Concorde.", desc: "A large playground set in the iconic Tuileries garden between the Louvre and Place de la Concorde — perfectly located for a post-museum family break. After the Louvre, grab pastries from a nearby boulangerie on Rue de Rivoli or Rue Montorgueil (just north) and picnic on the garden chairs. The carousel is a must for the little ones. Free to enter the garden; small fee for some equipment. 🗺️ https://maps.google.com/?q=Jardin+des+Tuileries+Playground+Paris+75001", kidFriendly: true },
      { name: 'Parc des Buttes-Chaumont — Playground', lat: 48.8796, lon: 2.3817, category: 'playground', award: 'Most dramatic park in Paris — cliffs, lake, temple on a rocky island', tagline: "Paris's wildest park. A cliff, a lake, a suspension bridge, a massive playground.", desc: "The most dramatic and underrated park in Paris. A fake cliff with a temple on top, a lake with an island, a suspension bridge — and a massive playground at the base. Combine with the excellent Sunday market at the nearby Marché d'Aligre (short taxi ride) — one of Paris's best and most authentic food markets. Locals adore this park. Tourists don't know it exists. 🗺️ https://maps.google.com/?q=Parc+des+Buttes-Chaumont+Paris+75019", kidFriendly: true },
      { name: 'Aire de Jeux — Île Saint-Louis', lat: 48.8520, lon: 2.3542, category: 'playground', award: '⭐ Market combo: Berthillon ice cream steps away', tagline: "Small charming playground on the island. Get Berthillon after.", desc: "A small but charming playground on the tip of Île Saint-Louis. The genius combo: kids play, then everyone gets Berthillon ice cream (the legendary Paris institution, steps away). The island itself is magical to explore with kids — no cars, quiet streets, beautiful architecture. A perfect afternoon loop: playground → Berthillon → walk the island. 🗺️ https://maps.google.com/?q=Square+Barye+Ile+Saint-Louis+Paris+75004", kidFriendly: true },
    ],
  },
  {
    city: 'Saint-Rapha\u00EBl',
