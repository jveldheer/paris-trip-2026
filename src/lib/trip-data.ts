...
export const STATIC_ITINERARY: Record<string, ItineraryItem[]> = {
  "2026-04-01": [
    item("flight", "UA3639 — GRR \u2192 EWR", {
      ...
      end_time: "2026-04-01T15:42:00",
      location_name: "Gerald R. Ford International Airport (GRR)",
      address: "5500 44th St SE, Grand Rapids, MI 49512",
      description: "United Airlines UA3639. Departs 1:39 PM \u2192 Arrives Newark 3:42 PM EDT.",
  ...
  "2026-04-02": [
    ...
    item("flight", "DL8758 \u2014 EWR \u2192 CDG (Air France A350)", {
      ...
      end_time: "2026-04-03T06:10:00",
      location_name: "Newark Liberty International Airport (EWR)",
      address: "Newark Liberty International Airport, Newark, NJ",
      description: "Delta/Air France A350 Premium Economy. EWR \u2192 Paris Charles de Gaulle. Overnight flight. Departs 5:00 PM \u2192 Arrives CDG 6:10 AM (Terminal 2E).",
      notes: "Arrive CDG 6:10 AM Apr 3, Terminal 2E. Premium Economy \u2014 enjoy the flight!",
      url: "https://maps.google.com/?q=Newark+Liberty+International+Airport",
      sort_order: 2,
    }),
  ],
  ...
  "2026-04-11": [
    ...
    item("flight", "Ryanair FR486 \u2014 Marseille \u2192 Lisbon", {
      ...
      address: "Marseille Provence Airport, Marignane, France",
      booking_ref: "M41TMN",
      description: "Jared\u2019s family only (5 people). Departs 3:25 PM MRS \u2192 Arrives Lisbon ~5:45 PM LIS (Terminal 1).",
  ...
  "2026-04-15": [
    item("flight", "AA259 \u2014 Lisbon \u2192 Philadelphia \u2192 Grand Rapids", {
      start_time: "2026-04-15T11:05:00",
      end_time: "2026-04-15T14:05:00",
      location_name: "LIS \u2192 PHL \u2192 GRR",
      address: "Lisbon Humberto Delgado Airport, Lisbon, Portugal",
      description: "Final flight home. Departs Lisbon 11:05 AM \u2192 Arrives Philadelphia ~2:05 PM EST. Connect to GRR.",
      notes: "Terminal 1 at LIS. Arrive Philadelphia Terminal A.",
...
export const FLIGHTS = [
  {
    ...
    route: "GRR \u2192 EWR",
    flight: "UA3639",
    time: "Departs 1:39 PM \u2192 Arrives 3:42 PM",
  ...
  },
  {
    ...
    time: "Departs 5:00 PM \u2192 Arrives 6:10 AM (Apr 3)",
    notes: "Premium Economy \u2014 Terminal 2E at CDG",
    confirmation: null as string | null,
  },
  {
    date: "Apr 11",
    ...
    time: "Departs 3:25 PM \u2192 Arrives ~5:45 PM",
  ...
  },
  {
    ...
    route: "LIS \u2192 PHL \u2192 GRR",
    flight: "AA259",
    time: "Departs 11:05 AM \u2192 Arrives ~2:05 PM (PHL)",
